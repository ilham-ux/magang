...
require 'sess_time.php';
                ...
                <section class="content">
                    ...
                    ?>
                                    <table id="data_buku" class="table table-hover table-bordered table-condensed">
                  <thead>
                      <tr>
                    ...
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['judul'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Buku" href="hapus-buku.php?hal=hapus&kd=<?php echo $data['id_buku'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>                
                    <?php   
              } 
              ?>
                   </tbody>
                   </table>  
                  <?php $tampil=mysql_query("select * from data_buku order by id_buku");
